...
import com.breezemobilearndemo.features.addAttendence.model.LocationDataModel
import com.breezemobilearndemo.widgets.AppCustomEditText
import com.breezemobilearndemo.widgets.AppCustomTextView

class GenericDialogWithOutSearch: DialogFragment() {
    ...
    companion object{
        ...
        fun newInstance(headerText:String,pList: ArrayList<CustomData>, function: (CustomData) -> Unit): GenericDialogWithOutSearch {
            val dialogFragment = GenericDialogWithOutSearch()
            mList = pList
