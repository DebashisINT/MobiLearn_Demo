package com.breezemobilearndemo.features.nearbyshops.presentation
...
import com.breezemobilearndemo.app.utils.AppUtils.Companion.changeAttendanceDateFormatToCurrent
import com.breezemobilearndemo.app.utils.FTStorageUtils
...
import com.breezemobilearndemo.features.addshop.model.AssignedToShopListResponseModel
import com.breezemobilearndemo.features.addshop.model.QuestionSubmit
import com.breezemobilearndemo.features.addshop.model.UpdateAddrReq
import com.breezemobilearndemo.features.addshop.model.UpdateAddressShop
...
import com.breezemobilearndemo.features.addshop.presentation.*
...
import com.breezemobilearndemo.features.nearbyshops.model.StageListResponseModel
...
import com.breezemobilearndemo.features.shopdetail.presentation.AddCollectionDialog
...
import com.breezemobilearndemo.features.viewAllOrder.interf.QaOnCLick
...
//                            val uri = Uri.fromFile(file)
                ...
                val path = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS).toString() +"/breezemobilearndemoApp/SHOPDtls/"
                var pathNew = ""
                val dir = File(path)
                if (!dir.exists()) {
                    dir.mkdirs()
