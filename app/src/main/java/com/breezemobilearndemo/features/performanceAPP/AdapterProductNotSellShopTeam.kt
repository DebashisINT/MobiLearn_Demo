...
class AdapterProductNotSellShopTeam(var mContext: Context, var mList:ArrayList<String>):
    RecyclerView.Adapter<AdapterProductNotSellShopTeam.CrossSellProductViewHolder>(){
    ...
    inner class CrossSellProductViewHolder(itemview: View): RecyclerView.ViewHolder(itemview){
        ...
        fun bindItems(){
            itemView.tv_row_shop_name.text = mList.get(adapterPosition)
