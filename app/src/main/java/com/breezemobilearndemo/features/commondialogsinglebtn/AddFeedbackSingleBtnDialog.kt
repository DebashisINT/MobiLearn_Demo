package com.breezemobilearndemo.features.commondialogsinglebtn
...
import com.breezemobilearndemo.app.domain.ShopVisitCompetetorModelEntity
import com.breezemobilearndemo.app.domain.VisitRemarksEntity
...
import com.breezemobilearndemo.features.addshop.presentation.ProspectListDialog
import com.breezemobilearndemo.features.dashboard.presentation.DashboardActivity
import com.breezemobilearndemo.features.dashboard.presentation.VisitMultiContactAdapter
...
import com.breezemobilearndemo.features.nearbyshops.model.ProsListResponseModel
...
//                        mListener.onOkClick(tv_remarks_dropdown.text.toString().trim(), nextVisitDate, filePath,et_approxvalue_name.text.toString(),ProsId)
            ...
            audioRecRoot.id,et_audioNW.id ->{
                ...
                audioFileNW = File("/data/user/0/com.breezemobilearndemo/files", "recorded_audio${System.currentTimeMillis()}.mp3")
