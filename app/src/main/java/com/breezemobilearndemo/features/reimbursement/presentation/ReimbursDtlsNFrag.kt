...
// Revision History
// 1.0 ReimbursDtlsNFrag AppV 4.0.7 Saheli    02/03/2023 Timber Log Implementation
class ReimbursDtlsNFrag: BaseFragment(), DateAdapter.onPetSelectedListener, View.OnClickListener, TabLayout.OnTabSelectedListener, RadioGroup.OnCheckedChangeListener {
    ...
    companion object {
        ...
        fun newInstance(objects: Any): ReimbursDtlsNFrag {
            val fragment = ReimbursDtlsNFrag()
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        val view = inflater.inflate(R.layout.frag_reimbur_new, container, false)
    ...
    private fun setData() {
        ...
        if(reimbursementDetails?.visit_type_id.equals("4")){
            tabLayout.getTabAt(1)?.select()
