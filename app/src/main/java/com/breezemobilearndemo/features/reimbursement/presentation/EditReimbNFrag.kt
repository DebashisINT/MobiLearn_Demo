...
import com.breezemobilearndemo.features.reimbursement.api.deleteimageapi.DeleteImageRepoProvider
import com.breezemobilearndemo.features.reimbursement.api.editapi.ReimbursementEditRepoProvider
...
import com.breezemobilearndemo.features.reimbursement.model.reimbursementlist.ReimbursementListDataModel
import com.breezemobilearndemo.features.reimbursement.model.reimbursementlist.ReimbursementListDetailsModel
...
class EditReimbNFrag : BaseFragment(), DateAdapter.onPetSelectedListener, View.OnClickListener, TabLayout.OnTabSelectedListener, RadioGroup.OnCheckedChangeListener {
    ...
    companion object {
        ...
        fun newInstance(objects: Any): EditReimbNFrag {
            val fragment = EditReimbNFrag()
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        val view = inflater.inflate(R.layout.frag_edit_reimb_new, container, false)
    ...
    private fun setData() {
        ...
        if(reimbursementDetails?.visit_type_id.equals("1")){
            tabLayout.getTabAt(0)?.select()
        }else if(reimbursementDetails?.visit_type_id.equals("2")){
            tabLayout.getTabAt(1)?.select()
        }else if(reimbursementDetails?.visit_type_id.equals("3")){
        ...
        when (p0!!.id) {
            R.id.reimbursement_type_RL -> {
                ...
                if (conveyancePopupWindow != null && conveyancePopupWindow!!.isShowing)
                    ...
                    callExpenseTypeDropDownPopUp(reimbursement_type_RL, expenseTypesArrayList, expense_type_TV, resources.getDimensionPixelOffset(
                        R.dimen._270sdp))
            }
            R.id.addNewTA_TV -> {
...
//end mantis id 26741 Storage permission updation Suman 22-08-2023
    ...
    private fun showDeleteAlert(adapterPosition: Int) {
        ...
        CommonDialog.getInstance("Delete Alert", "Do you really want to delete this image?", getString(
