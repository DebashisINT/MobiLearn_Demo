package com.breezemobilearndemo.features.averageshop.presentation
...
import com.breezemobilearndemo.features.addshop.presentation.AdapterQuestionList
...
import com.breezemobilearndemo.features.returnsOrder.ViewAllReturnListFragment
    ...
    private fun whatsappApi(obj : VisitRevisitWhatsappStatus,shopObj: AddShopDBModelEntity,isNewShop:Boolean){
        try{
           ...
           /*     msgBody= "Hey there! \n" +
                ...
                msgBody= "Hey there!\n\n" +
                        "Hope you had a successful meeting with ${Pref.user_name.toString().trim()}.\n\n" +
                        "We’ll be happy to assist you. Explore our designs at: www.eurobondacp.com\n\n" +
                        "*Team Eurobond*"
                templateName = "happy_to_assist"
            }else {
                msgBody= "Hey there!\n" +
