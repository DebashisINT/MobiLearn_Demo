package com.breezemobilearndemo.features.attendance
...
class AttendanceFragment : BaseFragment(), CompoundButton.OnCheckedChangeListener, DatePickerDialog.OnDateSetListener, View.OnClickListener {
