package com.breezemobilearndemo.features.myorder.presentation
 ...
 */
class MyOrderListAdapter(context: Context,val listener:MyOrderListClickListener ): RecyclerView.Adapter<MyOrderListAdapter.MyOrderViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyOrderViewHolder {
        val v = layoutInflater.inflate(R.layout.inflate_my_order_item, parent, false)
