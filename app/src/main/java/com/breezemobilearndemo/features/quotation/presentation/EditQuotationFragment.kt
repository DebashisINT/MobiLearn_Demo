package com.breezemobilearndemo.features.quotation.presentation
...
import com.breezemobilearndemo.app.domain.BSListEntity
import com.breezemobilearndemo.app.domain.ModelEntity
import com.breezemobilearndemo.app.domain.QuotationEntity
...
import com.breezemobilearndemo.features.addshop.presentation.ModelListDialog
...
import com.breezemobilearndemo.features.nearbyshops.model.ModelListResponseModel
 ...
 */
class EditQuotationFragment : BaseFragment(), View.OnClickListener {
    ...
    private var bsId = ""
    private var quotId = ""
    private var quot: QuotationEntity? = null
    ...
    companion object {
        ...
        fun getInstance(quo_id: Any?): EditQuotationFragment {
            val fragment = EditQuotationFragment()
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        quot = AppDatabase.getDBInstance()?.quotDao()?.getSingleQuotation(quotId)
        if (quot != null)
            setData(quot)
        ...
        when {
            ...
            TextUtils.isEmpty(amount_EDT.text.toString().trim()) -> (mContext as DashboardActivity).showSnackMessage(getString(R.string.amount_error))
                ...
                if (quot?.isUploaded!!)
                    ...
                    (mContext as DashboardActivity).showSnackMessage("Sync this quotation first.")
            }
        }
    }
    ...
    private fun saveData() {
        ...
        AppDatabase.getDBInstance()?.quotDao()?.updateQuot(quot!!)
        ...
        if (AppUtils.isOnline(mContext))
            ...
            (mContext as DashboardActivity).loadFragment(FragType.QuotationDetailsFragment, true, quotId)
        }
    }
