package com.breezemobilearndemo.features.logoutsync.presentation
...
import com.breezemobilearndemo.CustomConstants


import com.breezemobilearndemo.R
import com.breezemobilearndemo.app.AppDatabase
...
import com.breezemobilearndemo.app.utils.Toaster
import com.breezemobilearndemo.base.BaseResponse
import com.breezemobilearndemo.base.presentation.BaseActivity
import com.breezemobilearndemo.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.breezemobilearndemo.features.billing.api.AddBillingRepoProvider
import com.breezemobilearndemo.features.billing.model.AddBillingInputParamsModel
...
import com.breezemobilearndemo.features.dashboard.presentation.ReasonDialog
...
import com.breezemobilearndemo.features.document.model.AddEditDocumentInputParams
import com.breezemobilearndemo.features.document.model.DocumentAttachmentModel
...
import com.breezemobilearndemo.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
import com.breezemobilearndemo.features.nearbyshops.model.updateaddress.AddressUpdateRequest
import com.breezemobilearndemo.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.breezemobilearndemo.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.breezemobilearndemo.features.orderhistory.model.*
...
import com.breezemobilearndemo.features.quotation.model.AddQuotInputModel
import com.breezemobilearndemo.features.shopdetail.presentation.api.EditShopRepoProvider
import com.breezemobilearndemo.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.breezemobilearndemo.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
...
import com.breezemobilearndemo.features.stockAddCurrentStock.ShopAddCurrentStockList
...
import com.breezemobilearndemo.features.stockCompetetorStock.ShopAddCompetetorStockProductList
...
import com.breezemobilearndemo.features.timesheet.model.AddTimeSheetInputModel
import com.breezemobilearndemo.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.breezemobilearndemo.features.viewAllOrder.model.AddOrderInputParamsModel
import com.breezemobilearndemo.features.viewAllOrder.model.AddOrderInputProductList
import com.breezemobilearndemo.mappackage.SendBrod
import com.breezemobilearndemo.widgets.AppCustomTextView
import com.breezemobilearndemo.MonitorService
import com.breezemobilearndemo.MySingleton
import com.breezemobilearndemo.app.AlarmReceiver
...
import com.breezemobilearndemo.features.addshop.presentation.ShopExtraContactReq
...
import com.breezemobilearndemo.features.dashboard.presentation.model.AudioSyncModel
...
import com.breezemobilearndemo.features.login.model.GetConcurrentUserResponse
...
import com.breezemobilearndemo.features.orderITC.SyncDeleteOpptL
import com.breezemobilearndemo.features.orderITC.SyncEditOppt
import com.breezemobilearndemo.features.orderITC.SyncOppt
import com.breezemobilearndemo.features.orderITC.SyncOpptProductL
import com.breezemobilearndemo.features.orderITC.SyncOrd
import com.breezemobilearndemo.features.orderITC.SyncOrdProductL
import com.breezemobilearndemo.features.performance.model.Gps_status_list
import com.breezemobilearndemo.features.performance.model.UpdateGpsInputListParamsModel
import com.breezemobilearndemo.features.returnsOrder.ReturnProductList
import com.breezemobilearndemo.features.returnsOrder.ReturnRequest
import com.breezemobilearndemo.features.viewAllOrder.model.NewOrderSaveApiModel
                                 ...
                                 doAsync {
                                     ...
                                     uiThread {
                                         ...
                                         try {
                                             ...
                                             var audFile = File("/data/user/0/com.breezemobilearndemo/files", fileName)
                                             audFile.delete()
                                         }catch (ex:Exception){
                                             ex.printStackTrace()
                                         }
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezemobilearndemologsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezemobilearndemologsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezemobilearndemologsample/log.zip").path);
