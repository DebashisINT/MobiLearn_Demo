 ...
 */
class WorkTypeAdapter(private val context: Context, private val workTypeList: ArrayList<WorkTypeEntity>?, private val listener: OnWorkTypeClickListener) :
        RecyclerView.Adapter<WorkTypeAdapter.MyViewHolder>() {
