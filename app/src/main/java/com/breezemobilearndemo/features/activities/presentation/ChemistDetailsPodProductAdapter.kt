 ...
 */
class ChemistDetailsPodProductAdapter(private val context: Context, private val productList: ArrayList<AddChemistProductListEntity>?) :
        RecyclerView.Adapter<ChemistDetailsPodProductAdapter.MyViewHolder>() {
