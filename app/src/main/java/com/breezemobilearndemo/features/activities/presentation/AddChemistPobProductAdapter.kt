 ...
 */
class AddChemistPobProductAdapter(private val context: Context, productList: ArrayList<ProductListModel>?, private val listener: OnProductClickListener) :
        RecyclerView.Adapter<AddChemistPobProductAdapter.MyViewHolder>(), Filterable {
