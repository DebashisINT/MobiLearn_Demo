...
import com.breezemobilearndemo.app.domain.AddDoctorEntity
import com.breezemobilearndemo.app.domain.AddDoctorProductListEntity
...
import com.breezemobilearndemo.features.activities.model.AddChemistProductModel
import com.breezemobilearndemo.features.activities.model.AddDoctorVisitInputModel
import com.breezemobilearndemo.features.activities.model.ProductListModel
...
class AddDoctorFragment : BaseFragment(), View.OnClickListener {
    ...
    private fun callUploadDocVisitApi(docVisit: AddDoctorVisitInputModel) {
        ...
        Timber.d("=====ADD DOCTOR VISIT INPUT PARAMS (ADD DOCTOR)======")
        ...
        BaseActivity.compositeDisposable.add(
                repository.uploadDoctorVisit(docVisit)
                        ...
                        .subscribe({ result ->
                            ...
                            Timber.d("ADD DOCTOR VISIT DETAILS : " + "RESPONSE : " + response.status + "\n" + "Time : " + AppUtils.getCurrentDateTime() + ", USER :" + Pref.user_name + ", MESSAGE : " + response.message)
                            ...
                            Timber.d("ADD DOCTOR VISIT DETAILS : " + "ERROR : " + "\n" + "Time : " + AppUtils.getCurrentDateTime() + ", USER :" + Pref.user_name + ", MESSAGE : " + error.localizedMessage)
                            progress_wheel.stopSpinning()
