...
class ActivityDetailsListFragment : BaseFragment(), DatePickerDialog.OnDateSetListener {
    ...
    private lateinit var rl_activity_details_mail: RelativeLayout
    ...
    companion object {
        fun newInstance(shopId: Any): ActivityDetailsListFragment {
            val fragment = ActivityDetailsListFragment()

            val bundle = Bundle()
            bundle.putString("shopId", shopId as String?)
    ...
    private fun initView(view: View) {
        view.apply {
            ...
            rl_activity_details_mail = findViewById(R.id.rl_activity_details_mail)
        }
    ...
    private fun initAdapter() {
        val list = AppDatabase.getDBInstance()?.activDao()?.getDateRangeShopIdWise(specifiedDate, specifiedToDate, shopId)
