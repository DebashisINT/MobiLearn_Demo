 ...
 */
class AddChemistProductAdapter(private val context: Context, productList: ArrayList<ProductListModel>?, private val listener: OnProductClickListener) :
        RecyclerView.Adapter<AddChemistProductAdapter.MyViewHolder>(), Filterable {
