...
import com.breezemobilearndemo.app.domain.OrderDetailsListEntity
import com.breezemobilearndemo.app.domain.OrderProductListEntity
import com.breezemobilearndemo.app.domain.OrderStatusRemarksModelEntity
import com.breezemobilearndemo.app.domain.ProductListEntity
import com.breezemobilearndemo.app.domain.StockDetailsListEntity
import com.breezemobilearndemo.app.domain.StockProductListEntity
...
import com.breezemobilearndemo.app.utils.ToasterMiddle
...
import com.breezemobilearndemo.features.shopdetail.presentation.ShopDetailFragment
...
import com.breezemobilearndemo.features.viewAllOrder.AddRemarksSignDialog
...
import com.breezemobilearndemo.features.viewAllOrder.model.NewOrderCartModel
    ...
    private fun saveOrder(){
        Handler().postDelayed(Runnable {
            ...
            if(tv_totalAmt.text.toString().toDouble() !=0.0 || Pref.IsAllowZeroRateOrder){
                ...
                orderListDetails.scheme_amount = "0"
