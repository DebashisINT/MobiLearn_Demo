package com.breezemobilearndemo.features.newcollection
...
import com.breezemobilearndemo.features.shopdetail.presentation.model.collectionlist.CollectionListDataModel
 ...
 */
// 1.0 NewCollectionListFragment AppV 4.0.6 saheli 12-01-2023 multiple contact Data added on Api called
...
//end AppV 4.2.2 tufan    20/09/2023 FSSAI Lic No Implementation 26813
    ...
    private fun callAddShopApiForSync(addShop: AddShopRequestData, shop_imgPath: String?, list: ArrayList<CollectionDetailsEntity>,
        ...
        Timber.d("=======SyncShop Input Params(New Collection)=========")
    ...
    private fun callShopActivitySubmit(shopId: String) {
        ...
        if (!Pref.isMultipleVisitEnable) {
            ...
            // 1.0 NewCollectionListFragment AppV 4.0.6  multiple contact Data added on Api called
