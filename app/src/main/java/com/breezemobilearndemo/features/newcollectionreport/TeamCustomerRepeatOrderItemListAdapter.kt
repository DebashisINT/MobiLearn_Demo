...
import com.breezemobilearndemo.app.domain.OrderDtlsTeamEntity
import com.breezemobilearndemo.app.domain.TeamAllShopDBModelEntity
...
import com.breezemobilearndemo.features.nearbyshops.model.NewOrderModel
import com.squareup.picasso.Picasso
import kotlinx.android.synthetic.main.inflater_customer_list_item.view.*


class TeamCustomerRepeatOrderItemListAdapter(context: Context, list: ArrayList<TeamAllShopDBModelEntity>, val listener: TeamRepeatOrderShopsListClickListener, private val getSize: (Int) -> Unit) :
        RecyclerView.Adapter<TeamCustomerRepeatOrderItemListAdapter.MyViewHolder>(), Filterable {
    private val layoutInflater: LayoutInflater
    private var context: Context
    private var mList: ArrayList<TeamAllShopDBModelEntity>
    private var tempList: ArrayList<TeamAllShopDBModelEntity>? = null
    private var filterList: ArrayList<TeamAllShopDBModelEntity>? = null
    ...
    class MyViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bindItems(context: Context, list: List<TeamAllShopDBModelEntity>, listener: TeamRepeatOrderShopsListClickListener) {
            try {
                ...
                /*20-12-2021*/
                val OrderavalibleByShopId = AppDatabase.getDBInstance()?.orderDtlsTeamDao()?.getListAccordingToShopId(list[adapterPosition].shop_id) as ArrayList<OrderDtlsTeamEntity>
                ...
                /*var shopActivityList = AppDatabase.getDBInstance()?.shopActivityDao()?.getShopActivityForIdDescVisitDate(list[adapterPosition].shop_id)
                ...
                itemView.iv_whatsapp.visibility=View.GONE
    ...
    fun updateAdapter(mlist: ArrayList<TeamAllShopDBModelEntity>) {
        this.mList = mlist
    ...
    inner class SearchFilter : Filter() {
        ...
        override fun publishResults(p0: CharSequence?, results: FilterResults?) {
            ...
            try {
                filterList = results?.values as ArrayList<TeamAllShopDBModelEntity>?
                mList?.clear()
    ...
    fun refreshList(list: ArrayList<TeamAllShopDBModelEntity>) {
        mList?.clear()
        mList?.addAll(list)
