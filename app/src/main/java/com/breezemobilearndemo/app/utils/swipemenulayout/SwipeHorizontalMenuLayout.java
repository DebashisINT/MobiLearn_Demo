package com.breezemobilearndemo.app.utils.swipemenulayout;
...
import com.breezemobilearndemo.app.utils.swipemenulayout.listener.SwipeSwitchListener;
import com.breezemobilearndemo.app.utils.swipemenulayout.swiper.LeftHorizontalSwiper;
import com.breezemobilearndemo.app.utils.swipemenulayout.swiper.RightHorizontalSwiper;
import com.breezemobilearndemo.app.utils.swipemenulayout.swiper.Swiper;
...
public class SwipeHorizontalMenuLayout extends SwipeMenuLayout {
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        if (mEndSwiper != null) {
            ...
            lp = (FrameLayout.LayoutParams) mEndSwiper.getMenuView().getLayoutParams();
        ...
        if (mBeginSwiper != null) {
            ...
            lp = (FrameLayout.LayoutParams) mBeginSwiper.getMenuView().getLayoutParams();
            tGap = getPaddingTop() + lp.topMargin;
