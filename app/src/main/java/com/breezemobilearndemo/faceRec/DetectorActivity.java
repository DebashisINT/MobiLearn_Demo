...
package com.breezemobilearndemo.faceRec;
...
import com.breezemobilearndemo.faceRec.customview.OverlayView;
import com.breezemobilearndemo.faceRec.env.BorderedText;
import com.breezemobilearndemo.faceRec.env.ImageUtils;
import com.breezemobilearndemo.faceRec.env.Logger;
import com.breezemobilearndemo.faceRec.tflite.SimilarityClassifier;
import com.breezemobilearndemo.faceRec.tracking.MultiBoxTracker;
;
...
//  private static final boolean TF_OD_API_ISx_QUANTIZED = false;
...
//        final int inHeight = transpose ? srcWidth : srcHeight;
  ...
  private void onFacesDetected(long currTimestamp, List<Face> faces, boolean add) {
    ...
    for (Face face : faces) {
      ...
      //float nose_x=nose.getPosition().x;
      //float nose_y=nose.getPosition().y;
      //float mouth_x=mouth.getPosition().x;
      //float mouth_y=mouth.getPosition().y;

      //face.getTrackingId();

      //Toast.makeText(this,String.valueOf(nose.getPosition())+" :: "+String.valueOf(mouth.getPosition()),Toast.LENGTH_SHORT).show();
      //Toast.makeText(this,String.valueOf(nose_x)+" :: "+String.valueOf(nose_y)+" ::\n "+String.valueOf(mouth_x)+" :: "+String.valueOf(mouth_y),Toast.LENGTH_SHORT).show();
            ...
            if (result.getId().equals("0")) {
              ...
              System.out.println("onFacesDetected < 1");
               ...
               if(isTrueFace){
                ...
                //startActivity(new Intent(this,FaceStartActivity.class));
                //finish();
              }
